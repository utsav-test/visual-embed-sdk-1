    ...
    useEffect(() => {
        if (dimensions.windowWidth > MAX_MOBILE_RESOLUTION) {
            if (leftNavWidth > 262 && leftNavWidth < 308) {
                ...
                setdocWidth(dimensions.windowWidth - 12);
            }
        } else {
            setdocWidth(dimensions.windowWidth + 50);
        }
    }, [dimensions.windowWidth, leftNavWidth]);
            ...
            <main ref={ref as React.RefObject<HTMLDivElement>}>
                ...
                <div
                    ...
                    style={{
                        ...
                        maxWidth: `${docWidth - LEFT_NAV_WIDTH_DESKTOP}px`,
                    }}
                >
                    <Search
                        value={query}
